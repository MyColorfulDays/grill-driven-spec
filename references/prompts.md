...
- verify dependency identity before installing anything: grill-me and grill-with-docs are workflow skills, OpenSpec and Lore are the intended project tools, and git is the system Git CLI
